    ...
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <fieldset>
          ...
          <button>Submit - {undefined}</button>
        </fieldset>
      </form>
      <h4>Accordian with HTML only</h4>
      {/* 
        * @see https://twitter.com/csaba_kissi/status/1528266703607631873 
        */}
      <details>
        <summary>Choose Something</summary>
        <ul>
          <li>JS</li>
          <li>CS</li>
          <li>PY</li>
